...
namespace GameEngine.Tests
{
    public class PlayerCharacterShould : IDisposable
    {
        ...
        [InlineData(50, 50)]
        [InlineData(101, 1)]
        public void TakeDamage_InlineDataSource(int damage, int expectedHealth)
        {
        ...
        public void TakeDamage_InternalDataSource(int damage, int expectedHealth)
        {
            _sut.TakeDamage(damage);
        ...
        public void TakeDamage_ExternalSource(int damage, int expectedHealth)
        {
            _sut.TakeDamage(damage);
        ...
        [Theory]
        [HealthDamageData]
        public void TakeDamage_CustomAttribute(int damage, int expectedHealth)
        {
            _sut.TakeDamage(damage);
